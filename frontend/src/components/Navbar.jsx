...
import { Shield, Sparkles, Lock, User, LogOut, LayoutDashboard, FileSpreadsheet, PlusCircle, BarChart3, Settings, Play, ArrowLeft } from "lucide-react";
import { useAuth } from "../context/AuthContext";
import { useCases } from "../context/CaseContext";
import { SecurityModal } from "./SecurityModal";

export const Navbar = ({ activeTab, setActiveTab, onRunDemo, onBack, canGoBack }) => {
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-3">
              ...
              {canGoBack && (
                <button
                  onClick={onBack}
                  className="flex items-center gap-1.5 px-3 py-1.5 bg-slate-800 hover:bg-slate-700 text-blue-300 hover:text-white rounded-xl text-xs font-bold border border-slate-700 transition-all shadow-xs shrink-0 cursor-pointer"
